...
<head>
    ...
    <script type="text/javascript">
       ...
       function search(){
          ...
          $.post("<?php echo U('Log/operalogSearch');?>",
...
<body>
  ...
  <div class="showPage"  align="center"  id="showPage" style="display:block;margin-top:-20px;">
    <?php
 require_once('page.class.php'); require_once('getTotal.php'); $showrow = 10; $curpage = empty($_GET['page']) ? 1 : $_GET['page']; $url = "?page={page}"; $getTotal = new getTotal(); $total = $getTotal->getTotal(); if($total > $showrow){ $page = new page($total, $showrow, $curpage, $url, 2); echo $page->myde_write("movie_list"); } ?>
  </div> 
         <!-- paging-->
      </div>
      <br>
