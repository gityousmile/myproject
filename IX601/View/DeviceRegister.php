      ...
      <div class="row">  
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6 container main-container" id="registContent">
                        ...
                        <div class="form-group ">
                            <input class="form-control" id="name" name="name" placeholder="设备别名" value="" type="text">
                        </div>

                        <div class="form-group">
                            <input class="form-control" id="id" name="id" placeholder="设备id" value="" type="tel">
                        </div>
                    ...
                    <div class="col-lg-6 container main-container wow bounceInDown" id="manage">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12" id="goback">
                            <button type="button" class="btn btn-info" style="width:80px;margin-bottom: 25px;">返回</button>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <script type="text/javascript">
            ...
            $("#btn_login").bind("click",function(){
                ...
                $.post('../Controller/DeviceController.php?method=registerDevice', {name:name,id:id,group_name:group_name}, function(response){
                    // alert(response);
                    if(response=="0"){
                        swal("该设备已注册");
                        setTimeout('window.location.href = "DeviceRegister.php"',1000);
                    ...
                    // window.location.href = "DeviceRegister.php";
                });
